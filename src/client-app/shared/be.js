var be = {
    ...
    getTicketStatus: function (type) {
        if (type == 1)
            return '<span class="text-warning text-glitch">Pending</span>';
        else if (type == 2)
            return '<span class="text-danger text-glitch">Rejected</span>';
        else if (type == 3)
            return '<span class="text-success text-glitch">Approved</span>';
    },
