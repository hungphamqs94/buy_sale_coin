            ...
            <div className="container">
                <div className="sec-inner align-items-center mb-30">
                    <div className="sec-heading">
                        ...
                        <h2 className="title mb-0 text-warning text-glow">FB Tokenomics</h2>
                    </div>
                            ...
                            <div className="col-md-2">
                                <div className="TokenomicsContentsLeft wow fadeInLeft" data-wow-delay="0.2s"
                                    ...
                                    <div className="TokenomicsListSect">
                                        <ul>
                                            <li>
                                                <span className="icon-muines-custom"></span>
                                                <div className="TokenomicsList_text">
                                                    <h4>Token Name</h4>
                                                    <h5 className="counter-number">FBS DeFi</h5>
                                                </div>
                                            </li>
                                            <li>
                                                <span className="icon-muines-custom"></span>
                                                <div className="TokenomicsList_text">
                                                    <h4>Token Symbol</h4>
                                                    <h5 className="counter-number">FB</h5>
                                                </div>
                                            </li>
                                            <li>
                                                <span className="icon-muines-custom"></span>
                                                <div className="TokenomicsList_text">
                                                    <h4>Decimals</h4>
                                                    <h5 className="counter-number">18</h5>
                                                </div>
                                            </li>
                                            <li>
                                                <span className="icon-muines-custom"></span>
                                                <div className="TokenomicsList_text">
                                                    <h4>Max. Supply</h4>
                                                    <h5 className="counter-number">500,000,000</h5>
                                                </div>
                                            </li>
                                            <li>
                                                <span className="icon-muines-custom"></span>
                                                <div className="TokenomicsList_text">
                                                    ...
                                                    <h5 className="counter-number">BSC BEP20</h5>
                                                </div>
                                            </li>
                                            <li>
                                                <span className="icon-muines-custom"></span>
                                                <div className="TokenomicsList_text">
                                                    ...
                                                    <h5 className="counter-number">BEP20</h5>
                                                </div>
                                            </li>
                                            <li>
                                                <span className="icon-muines-custom"></span>
                            ...
                            <div className="col-md-4">
                                <div className="TokenomicsContentsLeft wow fadeInLeft" data-wow-delay="0.2s"
                                    ...
                                    <h4 className="counter-number mb-2">Total Supply : <span
                                        className="counter text-success">500,000,000</span></h4>
                                    <h4 className="counter-number text-danger">Seed Round : $<span
                                        className="counter text-glow">0.02</span></h4>
                                    <div className="TokenomicsListSect">
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <div className="TokenomicsList_text">
                                                    ...
                                                    <h5 className="counter-number">25,000,000 | <span
                                            ...
                                            <li>
                                                ...
                                                <div className="TokenomicsList_text">
                                                    ...
                                                    <h5 className="counter-number">30,000,000 | <span
                                                        className="counter">6</span>%</h5>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <div className="TokenomicsList_text">
                                                    ...
                                                    <h5 className="counter-number">40,000,000 | <span
                                                        className="counter">8</span>%</h5>
                                                </div>
                                            </li>
                                            <li>
                                        ...
                                        <ul style={{ marginLeft: '15px' }}>
                                            <li>
                                                ...
                                                <div className="TokenomicsList_text">
                                                    ...
                                                    <h5 className="counter-number">50,000,000 | <span
                                                        className="counter">10</span>%</h5>
                                                </div>
                                            </li>
                                            <li>
                                                <span className="DrinkToEarnNetwork"></span>
                                                <div className="TokenomicsList_text">
                                                    <h4 className="text-glitch text-DrinkToEarnNetwork">FBS To Earn</h4>
                                                    <h5 className="counter-number">85,000,000 | <span
                                                        className="counter">17</span>%</h5>
                                                </div>
                                            </li>
                                            <li>
                                                <span className="MiningPool"></span>
                                                <div className="TokenomicsList_text">
                                                    <h4 className="text-glitch text-MiningPool">FBS Pool</h4>
                                                    <h5 className="counter-number">50,000,000 | <span
                                                        className="counter">10</span>%</h5>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div className="TokenomicsList_text">
                                                    <h4 className="text-glitch text-Game">Bounty</h4>
                                                    <h5 className="counter-number">5,000,000 | <span
                                                        className="counter">1</span>%</h5>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <div className="TokenomicsList_text">
                                                    <h4 className="text-glitch text-Liquidity">Liquidity</h4>
                                                    <h5 className="counter-number">75,000,000 | <span
